...
const SEGMENTS: Record<Variant, { desktop: Segment; mobile: Segment }> = {
  ...
  eckdaten: {
    desktop: {
      ...
      d: "M -20 200 C 120 200, 180 70, 320 70 S 520 200, 660 200 S 860 70, 1000 70 S 1150 190, 1230 150",
      nodes: [
        [150, 132],
        [450, 132],
        [830, 132],
    ...
    mobile: {
      viewBox: "0 0 400 400",
      d: "M -10 90 C 90 90, 140 40, 200 90 S 320 140, 410 90 M -10 300 C 90 300, 140 250, 200 300 S 320 350, 410 300",
      nodes: [
        [100, 90],
        [300, 90],
        [100, 300],
